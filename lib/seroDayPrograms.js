export const SERO_DAY_PROGRAM_STORAGE_KEY = 'sejong_sero_day_programs';

export const DEFAULT_SERO_DAY_PROGRAMS = [
  {
    ...
    summary: '공동 창업자들이 기획한 회원사 3분 브랜드 소개와 업종별 라운드테이블 프로그램입니다.',
  ...
  },
  {
    ...
    summary: '회원사 상품을 시민에게 소개하는 팝업마켓 운영 설명회와 브랜드 매칭 프로그램입니다.',
