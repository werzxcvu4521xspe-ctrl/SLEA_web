...
export default function NoticePage() {
  ...
  const categories = useMemo(() => (
    ['전체', ...Array.from(new Set(notices.map(notice => notice.category)))]
  ), [notices]);
            ...
            <form className="notice-write-form" onSubmit={handleCreateNotice}>
              <div className="form-two-col">
                <div className="notice-field">
                  ...
                  >
                    <option value="정기행사 안내">정기행사 안내</option>
                    <option value="세로데이 모집">세로데이 모집</option>
                    <option value="교육 안내">교육 안내</option>
                    <option value="지원사업 정보">지원사업 정보</option>
                    <option value="공모전 정보">공모전 정보</option>
                  </select>
                </div>
                <div className="notice-field">
